# site_mystartup_ppgai
PPG AI é uma solução de automação inteligente para clínicas que transforma o WhatsApp em um agendador 24/7. A assistente virtual qualifica leads, marca consultas e organiza a agenda automaticamente, eliminando filas de espera e garantindo que nenhum paciente seja perdido por falta de atendimento.

PPG AI - Automação Inteligente para Clínicas no WhatsApp
<img src="https://ppgai.netlify.app/logo.jpeg" alt="PPG AI - Atendimento automatizado para clínicas" width="50%">
1. **Descrição**
...
Em "Tarefas Repetitivas": Responder "qual o valor?", "quais os horários?" e "qual o endereço?" são as tarefas que mais consomem o tempo da equipe de recepção.

Em "Erro Humano no Agendamento": Anotações manuais em papel ou agendas físicas são fontes comuns de conflitos de horário e falhas de comunicação.

Em "Capacidade de Atendimento": Podemos observar que o volume de mensagens é maior que a capacidade da equipe de responder prontamente, resultando em um "gargalo" na comunicação.

Em "Perda de Pacientes": Este é o principal indicador negativo. Um número significativo de pacientes inicia um contato, mas não conclui o agendamento devido às barreiras citadas acima.
